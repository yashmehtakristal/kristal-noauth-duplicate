...
def display_document_from_uploaded_files(uploaded_files):
    ...
    # We will return this value containing content of all the document
    # content = ""
...
def read_documents_from_uploaded_files_old(uploaded_files):
    '''
    read_documents:
    Explanation: Reads the pdf documents from uploaded files
...
def save_uploaded_file(uploadedFiles):
    '''
    save_uploaded_file:
    Explanation: Takes the uploadedFiles and writes it to Document directory (This will be useful if deploying streamlit locally and want to save files sent)
